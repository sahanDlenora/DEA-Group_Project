...
<%
    ...
    List<Item> items = id.getSeedsItem();   
    %>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <div class="card crd-ho">
                            <div class="card-body text-center">
                                ...
                                <div class="d-flex flex-row justify-content-around">
                                    ...
                                    if(ln != null)
                                {%>
                                    <a href="../CartServlet?Id=<%=ids%>&Iname=<%=n%>&Iprice=<%=p%>&user_id=<%=ln.getId()%>" class="btn btn-danger btn-sm"><i class="fa-solid fa-cart-plus"></i> Add Cart</a>
                                <%
                                } %> 
